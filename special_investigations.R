  ...
  moduleServer(
    ...
    function(input, output, session){
      ...
      observeEvent(input$add_test, {
        ...
        si_deployment_exists_query <- paste0("select * from fieldwork.viw_deployment_full where term = 'Special' and (admin.fun_smp_to_system(smp_id) = ", rv$system_id(), " OR site_name = ", rv$system_id(), ") and deployment_dtime < '", input$date, "'::timestamp + interval '3 days' and deployment_dtime > '", input$date, "'::timestamp - interval '3 days'")
