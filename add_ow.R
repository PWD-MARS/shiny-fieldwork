  ...
  tabPanel(title = "Add/Edit Location", value = "add_ow",  
           ...
           fluidRow( 
            ...
            #conditional specific to smp
             ...
             conditionalPanel(condition = "input.at_smp > 0 && (input.ow_suffix.match('OW.*') || input.ow_suffix.match('MH.*') || input.ow_suffix.match('IC.*') || input.ow_suffix.match('GI.*') || input.ow_suffix.match('CS.*') || input.ow_suffix.match('CO.*')) || input.ow_suffix.match('SL.*') || input.ow_suffix.match('GW.*')",
                              ns = ns,
             ...
             conditionalPanel(condition = "input.at_smp > 0 && (input.ow_suffix.match('OW.*') || input.ow_suffix.match('GI.*') || input.ow_suffix.match('CS.*') || input.ow_suffix.match('CO.*') || input.ow_suffix.match('MH.*') || input.ow_suffix.match('IC.*'))",
                             ns = ns,
                             sidebarPanel(width = 12,
                            fluidRow(
                              column(12,
